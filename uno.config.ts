import { defineConfig, presetAttributify, presetTypography, presetWind } from 'unocss'
...
export default defineConfig({
  // 扫描文件配置
  content: {
    filesystem: ['components/**/*.{vue,js,ts}', 'composables/**/*.{js,ts}', 'assets/styles/**/*.{css,ts}', 'site/**/*.{vue,js,ts}']
  },
  presets: [
