...
/* 暗色模式下的功能指令标签 */
:global(html.dark) .command-tag {
  background: rgba(56, 189, 248, 0.15);
  border: 1px solid rgba(56, 189, 248, 0.3);
  color: #7dd3fc;
}

:global(html.dark) .command-tag:hover {
  background: #38bdf8;
  color: #1f2937;
  border-color: #38bdf8;
}
...
/* 暗色模式下的标签徽章 */
:global(html.dark) :deep(.tag-badge) {
  background: rgba(255, 255, 255, 0.15);
}

:global(html.dark) .command-tag:hover :deep(.tag-badge) {
...
/* 暗色模式 */
:global(html.dark) .tag-regex {
  background: rgba(192, 132, 252, 0.15);
  border-color: rgba(192, 132, 252, 0.3);
  color: #c084fc;
}

:global(html.dark) .tag-regex:hover {
  background: #c084fc;
  color: #1f2937;
  border-color: #c084fc;
}

:global(html.dark) .tag-over {
  background: rgba(74, 222, 128, 0.15);
  border-color: rgba(74, 222, 128, 0.3);
  color: #4ade80;
}

:global(html.dark) .tag-over:hover {
  background: #4ade80;
  color: #1f2937;
  border-color: #4ade80;
}
...
/* 暗色模式下的禁用状态 */
:global(html.dark) .command-tag.disabled {
  background: rgba(107, 114, 128, 0.15);
  border-color: rgba(107, 114, 128, 0.3);
  color: #6b7280;
}

:global(html.dark) .command-tag.disabled:hover {
